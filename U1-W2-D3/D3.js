...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  console.log("My Name is", charactersNames[i]);
}
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  switch (starWarsCharacters[i].eye_color) {
    ...
    default:
      eyeColor.otherColor.push(starWarsCharacters[i]);
      break;
  }
}
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  let currentValue = 0;
  while ((currentValue = starWarsCharacters.length.mass)) {
...
} else if (totalMass >= 500 < 700) {
  console.log("Ship is half loaded");
} else if (totalMass >= 700 < 900) {
  console.log("Warning: Load is over 700");
} else if (totalMass >= 900 < 1000) {
